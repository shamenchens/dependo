...
function generateHtml(graphData, identification) {
...
module.exports.output = function(dependencies, identification) {

    var graphData = generateGraphData(dependencies);
    return generateHtml(graphData, identification);

};

module.exports.outputSystemGraph = function(graphData, identification) {
    return generateHtml(graphData, identification);
};